    ...
    return (
        <div>
            <div className='page_banner'>
                <h2 className='page_banner_title'>Home/Blog</h2>
            </div>
            <div className='container mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 my-container mt-12 relative '>
                <div>
                    ...
                    <div className='blog-cart hover:bg-rose-200'>
                        <h2 className='blog-question text-btn-color'>Question.2 : What is react custom hook?</h2>
